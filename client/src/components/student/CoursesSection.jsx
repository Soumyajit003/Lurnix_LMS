...
const CoursesSection = () => {
  ...
  return (
    <div className="py-16 md:px-40 px-8">
      ...
      <Link to={'/course-list'} onClick={() => scrollTo(0, 0)} className="bg-purple-600 hover:bg-purple-500 shadow-lg shadow-purple-600/30 transition-all duration-300 rounded text-white md:px-10 px-7 md:py-3 py-2 mx-1">Show all courses</Link>
    </div>
  );
};
