...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-purple-200/70'>
      <h1 className='md:text-home-heading-large text-home-heading-small relative font-bold text-gray-800 max-w-3x1 mx-auto'>Education without <span className='text-primary'>limits</span>, <br />success without <span className='text-primary'>boundaries</span>!<img src={assets.sketch} alt="Sketch" className='md:block hidden absolute -bottom-7 right-0'/></h1>
