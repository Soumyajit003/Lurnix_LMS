        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            ...
            <label htmlFor='thumbnailImage' className='flex items-center gap-3'>
              <img src={assets.file_upload_icon} alt="" className='p-3 bg-primary rounded' />
                ...
                <div className="p-4">
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className="flex justify-between items-center mb-2">
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} target="_blank" className="text-primary">Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid'}</span>
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
              <div className="bg-purple-950/90 text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <button type='button' className="w-full bg-primary text-white px-4 py-2 rounded" onClick={addLecture}>Add</button>
