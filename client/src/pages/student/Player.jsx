      ...
      <div className=" text-gray-200" >
        ...
        <div className="pt-5">
          {courseData && courseData.courseContent.map((chapter, index) => (
            <div key={index} className="border border-white/10 bg-transparent/5 backdrop-blur-lg shadow-lg shadow-purple-900/20 mb-2 rounded-xl">
              <div
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-medium md:text-white text-sm">{chapter.chapterTitle}</p>
                </div>
