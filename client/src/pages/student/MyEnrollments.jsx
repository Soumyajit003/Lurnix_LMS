        ...
        <>
            ...
            <div className='md:px-36 px-8 pt-10'>
                ...
                {enrolledCourses.length > 0 ? (
                                ...
                                <tr key={index} className="border-b border-gray-500/20">
                                    <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3 ">
                                        ...
                                        <div className='flex-1'>
                                            ...
                                            <Line className='bg-gray-300 rounded-full' strokeColor="#9810fa" trailColor="" strokeWidth={2} percent={progressArray[index] ? (progressArray[index].lectureCompleted * 100) / progressArray[index].totalLectures : 0} />
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-4 py-3 max-sm:text-right">
                                        <button onClick={() => navigate('/player/' + course._id)} className='px-3 sm:px-5 py-1.5 sm:py-2 bg-primary max-sm:text-xs text-white'>
                    ...
                    <div className='flex flex-col items-center justify-center space-y-4 mt-20 text-center'>
                        <p className='text-gray-400 text-lg sm:text-xl'>You don't have any enrolled courses yet.</p>
                        <button
                            onClick={() => navigate('/course-list')}
                            className='px-8 py-3 bg-primary text-white rounded-md hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg'
                        >
                            Explore Courses
                        </button>
                    </div>
